#!/bin/bash
#website generate ny thelinuxchoice
...
printf "\e[1;34m | _/_  _  __   ______________ _______     __| _/ \e[0m\e[1;77m_                 \e[0m\n"
printf "\e[1;34m / __ |\ \/ \/ /  /  ___/ ____/  |  \__  \   / __ |  \e[0m\n"
printf "\e[1;34m / /_/ | \     /   \___ < <_|  |  |  // __ \_/ /_/ | \e[0m\n"
printf "\e[1;34m \____ |  \/\_/   /____  >__   |____/(____  /\____ |     \e[0m\n"
printf "\e[1;34m      \/               \/   |__|          \/      \/    locatorv1.1 \e[0m\n"
printf "\n"
printf "\e[1;34m :::\e[0m\e[1;77m Coded by: LentereHacker wwbsite generate from thelinuxchoice\e[0m\n"
